...
router.route("/createblog").get(isAuthenticated,renderCreateBlog).post(isAuthenticated,upload.single("image"),postCreateBlog)
...
router.route("/editBlog/:id").post(isAuthenticated,isValid,upload.single("image"),postEditblog)
